...
for index_iter in range(ITER):
    ...
    net = network.D3DTBTA_network(BAND, CLASSES_NUM)
    ...
    plt_path='./plts/'+Dataset+'/'+str(TRAIN_VALIDATION_SPLIT)+'/'
    ...
    net_save_path='./net/' + Dataset + '_'+ str(TRAIN_VALIDATION_SPLIT)+'/'
    # net save path
...
record.record_output(OA, AA, KAPPA, ELEMENT_ACC, TRAINING_TIME, TESTING_TIME,
                     'records/' + net.name + day_str + '_' + Dataset + 'split：' + str(TRAIN_VALIDATION_SPLIT) + 'lr：' + str(lr) + '.txt')
